...
<!-- End NavBar -->
	<div class="container">
			...
			<ul class="nav nav-tabs nav-justified" role="tablist">
  				<li role="presentation" class="active"><a href="#cars" data-toggle="tab" role="tab"><i class="material-icons" style="font-size: 36px">directions_car</i></a>
  				</li>
  				<li role="presentation"><a href="#bikes" data-toggle="tab" role="tab"><i class="material-icons" style="font-size: 36px">motorcycle</i></a></li>
			</ul>
			<div id="mytabcontent" class="tab-content">
  				<div role="tabpanel" class="tab-pane fade in active jumbotron" id="cars">	
					<form class="form-horizontal" action="http://localhost/php/car-registration.php" method="post" id="carform" enctype="multipart/form-data">
      					<fieldset>
							<!--Company For Cars -->
				...
				<div role="tabpanel" class="tab-pane fade jumbotron" id="bikes">
					<form class="form-horizontal" action="http://localhost/php/bike-registration.php" method="post" id="bikeform" enctype="multipart/form-data">
						<fieldset>
							<!--Company For Bike -->
							<div class="form-group">
